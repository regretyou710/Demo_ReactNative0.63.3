      ...
      <View style={styles.container}>
        ...
        <ScrollView style={{height: 50}}>
          ...
          <TouchableOpacity
            ...
            style={styles.button}>
            <Text style={styles.text}>Select Single{'\n'}選擇單張圖片</Text>
          </TouchableOpacity>
          <TouchableOpacity
          ...
          <TouchableOpacity
            ...
            style={styles.button}>
            <Text style={styles.text}>Select Single With Cropping{'\n'}裁切單張圖片</Text>
          </TouchableOpacity>
          <TouchableOpacity
          ...
          <TouchableOpacity
            ...
            style={styles.button}>
            <Text style={styles.text}>Select Multiple{'\n'}選擇多張圖片</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={this.cleanupImages.bind(this)}
            style={styles.button}>
            <Text style={styles.text}>Cleanup All Images{'\n'}清除所有圖片</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={this.cleanupSingleImage.bind(this)}
            style={styles.button}>
            <Text style={styles.text}>Cleanup Single Image{'\n'}清除單張圖片</Text>
          </TouchableOpacity>
        </ScrollView>
      </View>
    );
